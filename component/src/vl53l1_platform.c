...
int8_t VL53L1_WriteMulti(uint16_t dev, uint16_t index, uint8_t *pdata, uint32_t count)
{
	...
	{
		ESP_LOGE(TAG, "g_vl53l1x_write_multi_ptr is null");
		return 255;
	}
...
int8_t VL53L1_ReadMulti(uint16_t dev, uint16_t index, uint8_t *pdata, uint32_t count)
{
	...
	{
		ESP_LOGE(TAG, "g_vl53l1x_read_multi_ptr is null");
		return 255;
	}
...
int8_t VL53L1_WrByte(uint16_t dev, uint16_t index, uint8_t data)
{
	...
	{
		ESP_LOGE(TAG, "g_vl53l1x_write_byte_ptr is null");
		return 255;
	}
...
int8_t VL53L1_WrWord(uint16_t dev, uint16_t index, uint16_t data)
{
	...
	{
		ESP_LOGE(TAG, "g_vl53l1x_write_word_ptr is null");
		return 255;
	}
...
int8_t VL53L1_WrDWord(uint16_t dev, uint16_t index, uint32_t data)
{
	...
	{
		ESP_LOGE(TAG, "g_vl53l1x_write_dword_ptr is null");
		return 255;
	}
...
int8_t VL53L1_RdByte(uint16_t dev, uint16_t index, uint8_t *data)
{
	...
	{
		ESP_LOGE(TAG, "g_vl53l1x_read_byte_ptr is null");
		return 255;
	}
...
int8_t VL53L1_RdWord(uint16_t dev, uint16_t index, uint16_t *data)
{
	...
	{
		ESP_LOGE(TAG, "g_vl53l1x_read_word_ptr is null");
		return 255;
	}
...
int8_t VL53L1_RdDWord(uint16_t dev, uint16_t index, uint32_t *data)
{
	...
	{
		ESP_LOGE(TAG, "g_vl53l1x_read_dword_ptr is null");
		return 255;
	}
